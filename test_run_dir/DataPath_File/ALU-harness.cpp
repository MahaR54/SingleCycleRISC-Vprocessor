...
class ALU_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_in_B)));
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_in_A)));
...
int main(int argc, char **argv, char **env) {
    ...
    VALU* top = new VALU;
    std::string vcdfile = "test_run_dir/DataPath_File/ALU.vcd";
    ...
    Verilated::mkdir("test_run_dir/DataPath_File/logs");
    VerilatedCov::write("test_run_dir/DataPath_File/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
